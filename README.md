...
<body>
    <div>
        ...
        <p>🌱 <strong>As a student in JTC</strong>strong>, I'm not only learning the intricacies of programming but also exploring how technology can be a force for <em>positive change</em> in marginalized communities.</p>
